 ...
 * 3/16/15
 * Professor Lehr
 * Paycheck with Independent if statement
 */
//System Libraries
#include <iostream>
...
int main(int argc, char** argv) {
    ...
    if(hrsWkd >= oTime){ //Be careful with calculations; account for the more than an equal too
        payChk += payRate*((oRate-1)*(hrsWkd - oTime));
    }
        
   
    //Output the results to the screen
    cout << fixed << setprecision(2) << showpoint; //Sets how far beyond the decimal
